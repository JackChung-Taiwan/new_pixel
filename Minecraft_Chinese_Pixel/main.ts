...
namespace chinesePixel {
    ...
    //% blockId=minecraft_chinese_pixel_draw_text_rtl_v039
    //% block="畫出右到左32×32中文 $text|在 $position|正面朝向 $direction|顏色 $color|放大 $scale 倍|字距 $spacing"
    ...
    //% blockId=minecraft_chinese_pixel_draw_vertical_text_v039
    ...
    //% blockId=minecraft_chinese_pixel_text_width_v039
